...
public class AlarmUtil {
    ...
    public static void createAlarmIntent() {
        ...
        if(alarmIntent == null) {
            ...
            alarmPi = PendingIntent.getBroadcast(UtilsContextOfAmap.getContext(), 0, alarmIntent, 0);
            // AlarmManager对象,注意这里并不是new一个对象，Alarmmanager为系统级服务
            alarm = (AlarmManager) UtilsContextOfAmap.getContext().getSystemService(UtilsContextOfAmap.getContext().ALARM_SERVICE);
