...
public class AmapConfig implements AMapLocationListener {
    ...
    private void init(){
        ...
        powerManager = (PowerManager) UtilsContextOfAmap.getContext().getSystemService(Context.POWER_SERVICE);
        initLocation();
//        setMyLocationStyle();
    ...
    private void startAmapService() {
        ...
        serviceIntent = new Intent(UtilsContextOfAmap.getContext(), AmapBackGroundService.class);
        if (Build.VERSION.SDK_INT >= 26) {
            // Pre-O behavior.
            UtilsContextOfAmap.getContext().startForegroundService(serviceIntent);
        } else {
            UtilsContextOfAmap.getContext().startService(serviceIntent);
        }
    ...
    private void closeAmapService(){
        ...
        if (null != serviceIntent) {
            UtilsContextOfAmap.getContext().stopService(serviceIntent);
        }
    }
    ...
    private void registerPowerReceiver(){
        ...
        UtilsContextOfAmap.getContext().registerReceiver(WakeLockScreenReceiver, filter);
    }
    ...
    private void unregisterPowerReceiver() {
        ...
        if (null != WakeLockScreenReceiver) {
            UtilsContextOfAmap.getContext().unregisterReceiver(WakeLockScreenReceiver);
        }
